    ...
    <header className="py-5 w-full bg-white">
      <div className="max-padd-container flexBetween">
        ...
        <div className="flex-1">
          <Navbar menuOpened={menuOpened} toggleMenu={toggleMenu} containerStyle={`${menuOpened ? 'flex flex-col gap-y-12 h-screen w-[222px] absolute left-0 top-0 bg-white z-50 px-10 py-4 shadow-xl' : 'hidden xl:flex gap-x-5 xl:gap-x-8 medium-15 rounded-full px-2 py-1'}`}/>
        </div>
        ...
        <div className="flexBetween pag-x-2 xs:gap-x-8">
          {
            !menuOpened && (
              <FaBarsStaggered
                onClick={toggleMenu}
