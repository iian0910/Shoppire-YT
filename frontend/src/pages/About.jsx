        ...
        <div className="max-padd-container py-10 bg-white rounded-2xl my-6">
          ...
          <div className="flex flex-col xl:flex-row gap-10">
            ...
            <div className="flex-1 flex justify-center flex-col">
              ...
              <p className="py-5">Discover the essence of style, where each piece is crafted with care and precision. We bring fashion that speaks to individuality and quality. From tha latest trends to timeless classics, ew are dedicated to elevating your wardrobe with exceptional designs that fit every occasion, personality, and season, making fashion a true expression of self.</p>
