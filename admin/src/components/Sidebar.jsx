    ...
    <div className="max-sm:flexCenter max-xs:pb-3 rounded-xl bg-white pb-3 mb-3 sm:w-1/5 sm:min-h-screen pl-6 lg:pl-22 sm:pr-3">
      <div className="flex max-sm:items-center sm:flex-col pt-5">
        <div className="flex sm:flex-col gap-x-5 gap-y-8 sm:pt-10">
          <NavLink to={'/'} className={({isActive}) => isActive ? "active-link" : "flexStart gap-x-2 p-5 bold-15 text-secondary"}>
            <FaSquarePlus className="text-lg" />
            <div className="hidden lg:flex">Add Items</div>
          </NavLink>
          <NavLink to={'/list'} className={({isActive}) => isActive ? "active-link" : "flexStart gap-x-2 p-5 bold-15 text-secondary"}>
            <FaListAlt className="text-lg" />
            <div className="hidden lg:flex">List Items</div>
          </NavLink>
          <NavLink to={'/orders'} className={({isActive}) => isActive ? "active-link" : "flexStart gap-x-2 p-5 bold-15 text-secondary"}>
